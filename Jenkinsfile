                ...
                withSonarQubeEnv('SonarCloud') {
                    script {
                        if (isUnix()) {
                            ...
                            bat 'mvn sonar:sonar -Dsonar.projectKey=gestion-bibliotheque -Dsonar.organization=ayoubamqicher -Dsonar.host.url=https://sonarcloud.io -Dsonar.login=1cce6bb6723b95ebea5012601a12ff4c5446d1ac'
                        }
                    }
                }
            }
